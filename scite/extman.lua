...
-- ---------------------------------------------------------------------------------------------------------------------
-- scipm-extman install official extman (http://lua-users.org/wiki/SciteExtMan) but exclude some functions :
--  * exlude : automatique load of files in ext.lua.directory
--  * exclude : scite_Command()
--  * exclude : scite_Command 'Reload Script|reload_script|Shift+Ctrl+R' (but re-create by action in scipm-extman)
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------
-- remove by scipm-extman (but recreate in other hand in package.json)
-- ---------------------------------------------------------
...
-- --------------------------------------------------------------------------------------------------------------------------------
-- scipm.extman namespace
-- --------------------------------------------------------------------------------------------------------------------------------
scipm.extman = {}

-- scipm.extman.reload_script (global)
-- -------------------------------------------------------------------------------
scipm.extman.reload_script = reload_script;
